...
/*var Follow_Request = require('../models/follow-request');*/
...
function followRequest(req, res){
	...
	follow_request.user = req.user.sub;
	follow_request.followed = params.followed;
...
function deleteFollowRequest(req, res){
	var userId = req.user.sub;
	var followId = req.params.id;

	Follow_Request.find({'user':userId, 'followed':followId}).remove(err => {
...
function getFollowedUsersRequest(req, res){
	...
	Follow_Request.find({followed:userId}).populate('user').paginate(page, itemsPerPage, (err, follows, total) => {
